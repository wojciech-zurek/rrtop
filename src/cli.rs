...
pub fn cli() -> ArgMatches {
    App::new(NAME)
        ...
        .arg(Arg::new("username")
            .short('u')
            .about("User name to use when connecting to the server.")
            .required(false)
            .takes_value(true))
        .arg(Arg::new("password")
            .short('a')
            .about("Password to use when connecting to the server.")
            .required(false)
            .takes_value(true))
        ...
        .arg(Arg::new("draw-background")
            ...
            .required(false)
            .takes_value(true))
        .arg(Arg::new("file-log-path")
            .short('f')
            .about("Set file log path")
            .required(false)
            .takes_value(true))
        .get_matches()
}