...
pub fn new() -> ColorScheme {
    ColorScheme {
        ...
        stat_table_row_gauge_fg: Color::Reset,
        stat_table_row_gauge_bg: Color::Reset,
        ...
        raw_border_fg: Color::Reset,
        raw_table_header_fg: Color::Reset,
        raw_table_row_top_1_fg: Color::Reset,
        raw_table_row_top_2_fg: Color::Reset,
        raw_table_row_bottom_fg: Color::Reset,
        raw_table_row_highlight_bg: Color::Reset,
        slow_title_fg: Color::Reset,
        slow_border_fg: Color::Reset,
        slow_table_header_fg: Color::Reset,
        slow_table_row_top_1_fg: Color::Reset,
        slow_table_row_top_2_fg: Color::Reset,
        slow_table_row_bottom_fg: Color::Reset,
        slow_table_row_highlight_bg: Color::Reset,
