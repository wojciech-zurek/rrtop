...
pub fn new() -> ColorScheme {
    ColorScheme {
        ...
        calls_title_fg: Color::Reset.into(),
        calls_border_fg: DarkGray.into(),
        calls_table_header_fg: Cyan.into(),
        calls_table_row_gauge_fg: Blue.into(),
        calls_table_row_gauge_bg: Gray.into(),
        calls_table_row_top_1_fg: Color::Reset.into(),
        calls_table_row_top_2_fg: Blue.into(),
        calls_table_row_bottom_fg: Gray.into(),
        calls_table_row_highlight_bg: DarkGray.into(),

        warning_title_fg: Color::Reset.into(),
        warning_border_fg: DarkGray.into(),
